  ...
  theme: {
  	...
  	extend: {
  		fontFamily: {
  			...
  			mono: ['var(--font-jetbrains-mono)', 'monospace'], // Critical for the dev feel
  		},
  		borderRadius: {
  			lg: '0px', // FORCE SHARP EDGES
  			md: '0px',
  			sm: '0px',
            full: '9999px', // Only keep this for avatars/toggles if needed
  		},
  		colors: {
  			...
  			accent: {
  				DEFAULT: 'hsl(var(--accent))', // THE HYPER RED
